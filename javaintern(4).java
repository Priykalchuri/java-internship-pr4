...
public class TextBasedAdventure {
    ...
    public static void StartRoom() throws InterruptedException {
        String input;System.out.println("The room is dark and gloomy, it reeks of dead corpses and rotten food,");
        System.out
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(3000);System.out.println("ARE YOU READY BRAVE ADVENTURER");
        HP = maxHP;
        lvl = 1;
        def = 1;
        atk = 1;
